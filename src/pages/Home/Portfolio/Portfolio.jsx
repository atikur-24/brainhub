    ...
    <section className="bg-neutral-9">
      <div className="my-container ">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-24 gap-y-20">
          ...
          {/* Portfolio 2 */}
          <div className="flex flex-col gap-4 group cursor-pointer overflow-hidden justify-self-end max-w-[476px]">
            {/* <div className=""> */}
            <figure className="overflow-hidden">
          ...
          {/* Portfolio 3 */}
          <div className="flex flex-col gap-4 group cursor-pointer self-end justify-self-start overflow-hidden max-w-[476px]">
            <figure className="overflow-hidden">
          ...
          {/* Portfolio 4 */}
          <div className="flex flex-col gap-4 group cursor-pointe overflow-hidden">
            <figure className="overflow-hidden">
